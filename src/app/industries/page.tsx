...
export const metadata: Metadata = {
  title: "行业应用",
  description: "领跃协同制造管理云平台 (LeanLeap) 在各个行业的成功应用案例，涵盖汽车、电子、机械、化工等多个制造领域。",
}
...
const applications = [
  {
    ...
    caseStudy: "某知名车企通过协同制造平台实现采购到生产全流程协同，整体运营效率提升40%"
  },
  {
    industry: "电子制造",
    icon: "📱",
    ...
    caseStudy: "大型电子制造商通过供应链协同实现库存周转率提升60%"
  },
  {
    industry: "机械制造",
    icon: "⚙️",
  ...
  },
  {
    ...
    caseStudy: "化工企业实现批次质检与财务核算一体化，批次全程可追溯"
  }
]
